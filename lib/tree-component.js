...
export var TreeComponent = React.createClass({
  ...
  render: function() {
    ...
    return Reactionary.div(null,
      Reactionary.div({className: "es-container", onClick: this.toggle},
        Reactionary.div({className: arrowClass}),
        Reactionary.h5({className: iconClass}, " " + this.props.model.name)
      ),
